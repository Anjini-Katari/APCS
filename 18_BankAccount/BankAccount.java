...
public class BankAccount {
	...
	private String FullName; //instance var -> private 
...
We know because it initialized the instance varible message. The primary purpose of a constructor 
is to initialize instance variables so when we ran a class without writing a constructor and the 
instance variable was initialized it meant that java did it for us automatically.

Q3:Describe a test to determine whether Java provides a mean of outputting a STRING REPRESENTATION 
of an OBJECT?
We can print out the object name so in this case we could 'System.out.println(objectName)' and if 
it prints out all of the instance variables then Java does provide a means of outputting a string 
representation of an object. Otherwise it does not provide one.
*/
